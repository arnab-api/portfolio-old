Needed to customize the theme a bit. Could not make it work with the fork. Naturally the the theme changes did not get pushed to the theme submodules. That's why created a cleaned repo and published everything here.
